//Biblioteca de classe .NET

//A Biblioteca de Classes do .NET nos fornece uma infinidade de funcionalidades
//Podemos usar simplesmente referenciando as classes e os métodos de que precisamos.
//Até mesmo nossos tipos de dados fazem parte da Biblioteca de Classes do .NET.
//O C# simplesmente fornece um alias para esses tipos de dados.
//Um namespace impede a nomenclatura de colisões entre nomes de classe na Biblioteca de Classes do .NET.

//Para chamar métodos de uma classe na Biblioteca de Classes do .NET,
//Use o formato ClassName.MethodName(), em que o símbolo . é o operador de acesso de membro
//para acessar um método definido na classe e os símbolos () são os operadores de invocação de método.
